	...
	function customGeneralUpload() {
		...
		fdata.enctype = "multipart/form-date"
		fdata.method = "POST"
    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/bbs/multiImageUploader'; 	//upload URL
	 ...
	 */
 	...
 	function callFileUploader (){
 		...
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/bbs/singleImageUploader',	//샘플 URL입니다.
 	        sCallback : '/smarteditor2.8.2.3/sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
